...
const CustomerAddresses: React.FC<CustomerAddressesProps> = ({
  ...
  const removeAddress = (id: string) => {
    ...
    // If the removed address was default, clear default
...
// ----------------------------------------------------------------------
// Main CreateCustomerForm component
export function CreateCustomerForm() {
  ...
  const handleSubmit = (formData: FormData) => {
    // Find index of default address
    const defaultIndex = addresses.findIndex((addr) => addr.id === defaultAddressId);
    ...
    const payload = {
      ...
      defaultAddressIndex: defaultIndex >= 0 ? defaultIndex : undefined,
    };
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Add a new customer profile with contact information and addresses
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
